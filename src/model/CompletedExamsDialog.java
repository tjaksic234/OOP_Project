...
public class CompletedExamsDialog extends JDialog {
    ...
    public CompletedExamsDialog(JFrame parent) {
        super(parent, "Completed exams", true);
        setSize(600, 400);
        setLocationRelativeTo(parent);

        tableModel = new DefaultTableModel(new Object[]{"Student", "Subject", "Grade"}, 0);
                        ...
                        if (teacherSubjects.contains(subject)) {
                            if (grades.get(subject) != 0 && grades.get(subject) != null) {
                                tableModel.addRow(new Object[]{
                                        student.getName() + " " + student.getSurname(), subject, grades.get(subject)});
                            }
                        }
                    }
                }
